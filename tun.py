...
while 1:
    ...
    packet_wrapped = IP(src='10.5.0.100', dst='129.170.239.178')/UDP(sport=2003, dport=18958)/Raw(binary_packet)
    ...
    sendp(packet_wrapped, iface="eth0")



    packet_wrapped.show()
    #os.write(sock.fileno(), str(packet_wrapped))
    ...
    # os.write() that packet to tun interface
